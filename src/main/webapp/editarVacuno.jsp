<%-- 
    ...
    Author     : Marcosz
--%>
<%@page import="transferObject.vacunoTO"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="box box-info">
            ...
            <!-- form start -->
            <form class="form-horizontal" action="vacunoController" method="POST">
                <%vacunoTO vacuno = (vacunoTO) session.getAttribute("update");%>              
                <div class="box-body">
           ...
           <div class="form-horizontal">
             ...
             <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <input type="hidden" name="action" value="actualizarVacuno">
